...
from APIs.OpenWeatherMap import obtener_tiempo  # Importar la función obtener_tiempo
from APIs.REData import get_real_time_market_prices  # Importar la función get_real_time_market_prices
